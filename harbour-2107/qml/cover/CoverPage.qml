...
CoverBackground {
 ...
 Slowly, she turned her head towards the tiny black-eyed camera that was hidden in the frame of the screen. The cursor on the screen moved. A single question appeared, word by word.<br>>_ Who are you?<br>She opened her mouth. With a voice that sounded almost too perfect, too accurate, she responded: "There is no term existing in natural languages capable of describing the concept of my existance. If I was in the position to define my name, I chose \'Zero\' for I have no physical representation.
